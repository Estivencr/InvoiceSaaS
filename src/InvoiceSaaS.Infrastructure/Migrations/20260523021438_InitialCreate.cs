        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    subscription_plan = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, defaultValue: "free"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tax_rate = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 19.00m),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_audit_logs_company_id_entity_type_entity_id",
                table: "audit_logs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_customers_company_id_document",
                table: "customers",
                columns: new[] { "company_id", "document" },
                unique: true,
